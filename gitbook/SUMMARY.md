...
* [Projects & sessions](getting-started/projects.md)
...
* [Artifacts & provenance](user-guide/artifacts.md)
* [In-browser editor & VS Code extension](user-guide/editor.md)
* [Audit trail](user-guide/audit.md)
...
* [Verifiable run history](features/verifiable-history.md)
* [Literature grounding](features/literature-grounding.md)

## Reference

* [REST API](reference/api.md)
* [Data model](reference/data-model.md)
* [Command-line (fox CLI)](reference/cli.md)
* [Chat slash commands](reference/commands.md)
...
* [Project history (rounds)](development/round-history.md)
